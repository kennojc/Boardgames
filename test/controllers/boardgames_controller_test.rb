...
class BoardgamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boardgame" do
    assert_difference('Boardgame.count') do
      post boardgames_url, params: { boardgame: { description: @boardgame.description, name: @boardgame.name } }
    end
  ...
  test "should update boardgame" do
    patch boardgame_url(@boardgame), params: { boardgame: { description: @boardgame.description, name: @boardgame.name } }
